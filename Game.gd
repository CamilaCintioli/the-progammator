...
func add_exceptions(cannon):
	cannon.add_collision_exception_to_projectile($TileMap)
	cannon.add_collision_exception_to_projectile($TileMap2)
	cannon.add_collision_exception_to_projectile($EndMovingPlatform/Platform)
	cannon.add_collision_exception_to_projectile($endEnviroment/Platform)
	cannon.add_collision_exception_to_projectile($endEnviroment/Platform2)
	cannon.add_collision_exception_to_projectile($endEnviroment/Platform3)
	cannon.add_collision_exception_to_projectile($endEnviroment/Platform4)
	cannon.add_collision_exception_to_projectile($endEnviroment/Platform5)
	cannon.add_collision_exception_to_projectile($endEnviroment/Platform6)
	cannon.add_collision_exception_to_projectile($endEnviroment/Platform7)
	cannon.add_collision_exception_to_projectile($endEnviroment/Platform8)
	cannon.add_collision_exception_to_projectile($endEnviroment/Platform9)
	cannon.add_collision_exception_to_projectile($endEnviroment/Platform10)
	cannon.add_collision_exception_to_projectile($endEnviroment/Platform11)
	cannon.add_collision_exception_to_projectile($endEnviroment/Platform12)
	cannon.add_collision_exception_to_projectile($endEnviroment/Platform13)
	cannon.add_collision_exception_to_projectile($endEnviroment/Platform14)
	cannon.add_collision_exception_to_projectile($endEnviroment/Platform15)
	cannon.add_collision_exception_to_projectile($endEnviroment/Platform16)
	cannon.add_collision_exception_to_projectile($endEnviroment/Platform17)
	cannon.add_collision_exception_to_projectile($endEnviroment/Platform18)
	cannon.add_collision_exception_to_projectile($endEnviroment/BreakablePlatform)
	cannon.add_collision_exception_to_projectile($endEnviroment/BreakablePlatform2)
	cannon.add_collision_exception_to_projectile($endEnviroment/BreakablePlatform3)
	cannon.add_collision_exception_to_projectile($endEnviroment/MovingPlatform)
	cannon.add_collision_exception_to_projectile($endEnviroment/MovingPlatform2)
